...
pkgs = ['selenium', 'XlsxWriter', 'openpyxl', 'xlrd', 'chromedriver.py']
...
chrome = webdriver.Chrome(executable_path=binary_path, options=options)
...
wb = xlrd.open_workbook('/Users/%s/Desktop/ELPAC.xlsx' % str(name))
sheet1 = wb.sheet_by_index(0)

#creating a new excel workbook which will contain all the necessary data
workbook = xlsxwriter.Workbook('/Users/%s/Desktop/elpac_cards.xlsx' % str(name))
